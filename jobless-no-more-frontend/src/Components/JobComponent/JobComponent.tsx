  ...
  return (
      ...
      <div className="job-component-titles">
          ...
          <div className="job-for-website">
           ...
           <div className="job-info">
            ...
            <div className="job-paragraph">
              ...
              Sapiente enim laudantium, minus ex voluptates velit quia, 
              adipisci quam repudiandae ea quisquam facere distinctio aperiam, quasi commodi amet delectus sint natus.
            </div>
        ...
        <div className="jobs-right-side">
            <div className="jobs-entry">🧠Entry
