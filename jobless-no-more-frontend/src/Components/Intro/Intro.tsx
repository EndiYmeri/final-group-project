      ...
      <section className="second-section">
        <div className="for-clients-section">
          ...
          <div className="btn-for-client">
            <button className="button-for-job">Post a job and hire a pro</button>
            <button className="button-for-projects">Browse and buy projects</button>
            <button className="button-for-talent">Let us help you find the right talent</button>
          </div>
        </div>
      </section>
    </div>
