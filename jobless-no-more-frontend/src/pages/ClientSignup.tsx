    ...
    <main className="signup-main">
      <div className="signup-container">
        <div className="signup-section">
          <h2>Join example a client or freelancer</h2>
          <form>
            <div className="signup-section-selection">
              <label className="client-radio">
                <svg
                ...
                >
                  ...
                  <path
                    ...
                    fill="var(--illustration-color-15, #171719)"
                  ></path>
                  <path
              ...
              <label className="freelancer-radio">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 145 130"
                  aria-hidden="true"
                ...
                >
                  ...
                  <path
                    ...
                    fill="var(--illustration-color-5, #b7d3c4)"
                  ></path>
                  <polygon
            ...
            {selectedOption === "freelance" ? (
              <button type="submit" className="freelance-btn">
                Apply as a Freelance
              </button>
            ) : null}
            {selectedOption === "client" ? (
              <button type="submit" className="client-btn">
                Join as a Client
              </button>
            ) : null}
            {selectedOption === "" ? (
