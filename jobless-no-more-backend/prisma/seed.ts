...
const jobs: Prisma.jobCreateInput[] = [
    {
        ...
        content: 'I have a figma, requires few hours of work, HTML/CSS. I need someone who speak English please so that I am able to work with her/him. This is a start of bigger project but need someone who is committed and deliver fast with Quality',
        location: 'Worlwide',
    ...
    },
    {
        ...
        content: 'I need someone who can perfectly edit and fix some details in our web page.        ',
        location: 'Albania',
        Category: { connect: { name: 'IT & Networking' } },
    ...
    },
    {
        ...
        content: 'I already have a logo i just need it resized for letter head, then a business card and flyer creation.',
        location: 'Worlwide',
    ...
    },
    {
        ...
        content: 'Looking for a front-end dev, templates creator who will be able to recreate a couple of specific HTML templates.Thanks,Daniel',
        location: 'France',
        Category: { connect: { name: 'IT & Networking' } },
        difficulty: { connect: { name: 'Intermediate' } },
        clientUser: { connect: { email: 'denis@email.com' } },
    ...
    },
    {
        ...
        content: 'Translator needed to work on a Code of Ethics. Languages: Spanish to Chinese (PRC). Word count: 5365. When proposing, please point your price per word for translation services. Do you work in CAT tools?',
        location: 'Worlwide',
        Category: { connect: { name: 'Legal' } },
        difficulty: { connect: { name: 'Intermediate' } },
        clientUser: { connect: { email: 'ani@email.com' } },
    ...
    },
    {
        ...
        content: 'The task here is to assist Amazon internet shopping platform merchants in improving their sales rankings. You can receive a cash incentive for assisting in the accomplishment this activity.',
        location: 'Worlwide',
...
const skills: Prisma.SkillCreateInput[] = [
    {
        name: 'HTML5',
        freelanceUsers: { connect: [{ email: 'besim@email.com' }, { email: 'endi@email.com' }, { email: 'artiola@email.com' }] },
